...
INSERT INTO public.users VALUES (1, 'João', 'joao@driven.com.br', '$2b$10$SDDP4q7Lny07tcsBTcVGbuC4c22E2EbFFVTTuvUmnxPes/NoC6RYS', '2023-03-01 15:32:29.756');
...
--
-- Name: urls urls_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.urls
    ADD CONSTRAINT urls_user_id_key UNIQUE (user_id);
